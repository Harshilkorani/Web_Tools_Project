  ...
  <div class="row" id="pwd-container">
    ...
    <div class="col-md-4">
      <section class="login-form">
        <form method="POST" action="supplierProfile1.htm" role="login">
          <img src="resources/images/sports_company1.jpg" class="img-responsive" alt="sports_company" />
          <input type="email" name="email_id" placeholder="Email" required class="form-control input-lg" placeholder="Email" />
          ...
          <div>
            <a href="RegisterSupplier.htm">Create account</a>
          </div>
