...
<div id="wrapper">
    ...
    <div class="row" id="imageHa">
		...
		<!-- 	<div class="col-sm-8 col-md-4"> -->
				<div class="thumbnail" >			<h4 class="text-center"><span class="label label-info">Product ID: ${Product.product_id}</span></h4>
					<img src="<c:out value='${Product.product_image}'/>"  class="img-responsive" width="500px" height="400px">
					<div class="caption">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<a href="Payment.htm" class="btn btn-success btn-product"><span class="glyphicon glyphicon-shopping-cart"></span> Buy</a></div>
						</div>				
